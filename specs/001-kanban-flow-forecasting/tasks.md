...
- [x] T020 [US1] Build the admin setup and edit screens plus the synced flow summary page in apps/web/src/app/admin/jira/page.tsx, apps/web/src/components/admin/jira-connection-form.tsx, apps/web/src/components/admin/flow-scope-form.tsx, and apps/web/src/app/scopes/[scopeId]/page.tsx
- [x] T021 [P] [US1] Add contract tests for admin connection create/update/validation, board discovery, scope create/update, boundary-change sync conflicts, and sync routes in tests/contract/admin-jira-connections.contract.test.ts and tests/contract/admin-scopes.contract.test.ts
- [x] T022 [P] [US1] Add integration tests for Jira sync normalization and projection publishing in tests/integration/sync-pipeline.integration.test.ts and end-to-end coverage for Jira connection create/edit, scope create/edit, sync, and flow summary in tests/e2e/admin-jira-setup.spec.ts
